...
execute as @e[tag=enemy,nbt=!{HurtTime:10s},dx=0,limit=3,distance=..2] positioned ~-.99 ~-.99 ~-.99 if entity @s[distance=..2] run function kcs:main/skill/id/sword/211/damage with storage kcs:function Battle
