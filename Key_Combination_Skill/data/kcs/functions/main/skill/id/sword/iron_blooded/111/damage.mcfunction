...
execute as @s store result score r1 KCS.reg run attribute @s generic.max_health get 100
...
execute as @s run function kcs:main/skill/id/sword/iron_blooded/111/bleed with storage kcs:function Battle