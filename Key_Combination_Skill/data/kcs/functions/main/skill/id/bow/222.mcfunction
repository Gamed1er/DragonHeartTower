...
execute unless score @s KCS.Players.arrow.count matches 7.. run function kcs:main/skill/id/bow/text/not_enough

execute at @s as @e[tag=KCS.marker.vector] positioned 0.0 0.0 0.0 rotated ~-75 ~ run tp @s ~ ~ ~ ~ ~
tag @s add KCS.Players.arrow.Owner
execute at @s positioned ~ ~1.25 ~ rotated ~-60 ~ run function kcs:main/skill/id/bow/222/sector
