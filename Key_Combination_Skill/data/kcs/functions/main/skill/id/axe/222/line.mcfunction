...
execute if score @s KCS.Skill.Range matches 1..6 as @e[tag=enemy,nbt=!{HurtTime:10s},limit=1,distance=..1.2] positioned ~ ~ ~ if entity @s[] run function kcs:main/skill/id/axe/222/damage with storage kcs:function Battle
...
execute if score @s KCS.Skill.Range matches 6.. as @e[tag=enemy,nbt=!{HurtTime:10s},limit=1,distance=..1.2] positioned ~ ~ ~ if entity @s[] run function kcs:main/skill/id/axe/222/damage with storage kcs:function Battle

execute unless score @s KCS.Skill.Range matches 9.. positioned ^ ^ ^.5 run function kcs:main/skill/id/axe/222/line