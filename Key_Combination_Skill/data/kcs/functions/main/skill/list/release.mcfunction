...
execute as @s if data entity @s Inventory[{Slot:-106b}] if data entity @s Inventory[{Slot:0b}] run function kcs:main/skill/list/item with storage kcs:function reg.item
