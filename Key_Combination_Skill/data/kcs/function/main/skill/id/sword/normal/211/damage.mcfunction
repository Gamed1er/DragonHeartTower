...
execute as @s if entity @s[tag=!boss] run data modify entity @s Motion[1] set value 1.0
execute as @s if entity @s[tag=boss] run data modify entity @s Motion[1] set value 0.2