...
execute as @e[tag=enemy,distance=..0.9] positioned ~ ~ ~ if entity @s[] run function kcs:main/skill/id/sword/normal/122/damage with storage kcs:function Battle
...
execute unless score @s KCS.Skill.Range matches 10.. positioned ^ ^ ^.25 unless block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~2 ~ air positioned ~ ~1 ~ run return run function kcs:main/skill/id/sword/normal/122/line
execute unless score @s KCS.Skill.Range matches 10.. positioned ^ ^ ^.25 if block ~ ~ ~ air if block ~ ~1 ~ air run function kcs:main/skill/id/sword/normal/122/line
