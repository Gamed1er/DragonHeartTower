...
execute if score @s KCS.Skill.Range matches 10.. as @e[tag=enemy,limit=8,distance=..0.9] positioned ~ ~ ~ if entity @s[] run function kcs:main/skill/id/pickaxe/normal/111/damage with storage kcs:function Battle
...
execute if score @s KCS.Skill.Range matches 5..9 as @e[tag=enemy,limit=8,distance=..0.9] positioned ~ ~ ~ if entity @s[] run function kcs:main/skill/id/pickaxe/normal/111/damage with storage kcs:function Battle
...
execute unless score @s KCS.Skill.Range matches 12.. positioned ^ ^ ^.25 run function kcs:main/skill/id/pickaxe/normal/111/line