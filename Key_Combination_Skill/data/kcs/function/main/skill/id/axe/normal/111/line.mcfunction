...
execute if score @s KCS.Skill.Range matches 12.. as @e[tag=enemy,limit=8,distance=..0.9] positioned ~ ~ ~ if entity @s[] run function kcs:main/skill/id/axe/normal/111/damage with storage kcs:function Battle
...
execute if score @s KCS.Skill.Range matches 5..11 as @e[tag=enemy,limit=8,distance=..0.9] positioned ~ ~ ~ if entity @s[] run function kcs:main/skill/id/axe/normal/111/damage with storage kcs:function Battle
...
execute unless score @s KCS.Skill.Range matches 15.. positioned ^ ^ ^.25 run function kcs:main/skill/id/axe/normal/111/line