...
title @s subtitle {"translate":"text.todh.kcs.axe.skill.normal.111.name","color":"aqua"}
title @s title [""]

tag @s add KCS.attacker.detect
execute at @s positioned ~ ~0.25 ~ rotated ~ -120 positioned ^ ^ ^ run function kcs:main/skill/id/axe/normal/111/sector
