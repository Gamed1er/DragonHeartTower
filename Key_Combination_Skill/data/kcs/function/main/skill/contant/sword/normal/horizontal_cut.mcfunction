...
title @s subtitle {"translate":"text.todh.kcs.sword.skill.normal.horizontal_cut.name","color":"aqua"}
title @s title [""]

tag @s add KCS.attacker.detect
execute at @s positioned ~ ~1 ~ rotated ~-90 0 run function kcs:main/skill/contant/sword/normal/horizontal_cut/sector
