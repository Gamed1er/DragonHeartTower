...
execute as @e[tag=enemy,nbt=!{HurtTime:10s},dx=0,limit=1] positioned ~-.99 ~-.99 ~-.99 if entity @s[dx=0] run return run function kcs:main/skill/contant/sword/iron_blooded/blood_thirst/damage with storage kcs:function Battle


execute unless score @s KCS.Skill.Range matches 27.. positioned ^ ^ ^.25 run function kcs:main/skill/contant/sword/iron_blooded/blood_thirst/line