...
title @s subtitle {"translate":"text.todh.kcs.sword.skill.normal.pucture.name","color":"aqua"}
title @s title [""]

tag @s add KCS.attacker.detect
execute at @s anchored eyes positioned ^ ^ ^.25 run function kcs:main/skill/contant/sword/normal/puncture/line
