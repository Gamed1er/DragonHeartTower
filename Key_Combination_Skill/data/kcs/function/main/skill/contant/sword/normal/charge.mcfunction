...
title @s subtitle {"translate":"text.todh.kcs.sword.skill.normal.charge.name","color":"aqua"}
title @s title [""]


tag @s add KCS.attacker.detect
execute at @s positioned ~ ~ ~ rotated ~ 0 positioned ^ ^ ^ run function kcs:main/skill/contant/sword/normal/charge/line
