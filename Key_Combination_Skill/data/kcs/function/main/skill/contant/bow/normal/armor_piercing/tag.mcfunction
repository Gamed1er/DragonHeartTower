...
execute as @e[tag=KCS.arrow.piercing] as @s run data modify entity @s PierceLevel set value 1

# execute as @s at @s positioned ^ ^ ^.25 run playsound minecraft:item.trident.throw master @p ~ ~ ~ 1 2
