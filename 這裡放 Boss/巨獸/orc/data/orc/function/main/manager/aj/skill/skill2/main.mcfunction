...
execute as @s at @s as @n[tag=aj.orc.root] run function animated_java:orc/animations/animation.model.skill2_ready/play


execute as @s run tag @s add ToDH.Boss.Action.InAction
schedule function orc:main/manager/aj/skill/skill2/schedule 330t
execute as @s run scoreboard players reset @s ToDH.Boss.1_Orc.Action.Tick
function orc:main/manager/aj/skill/skill2/tick