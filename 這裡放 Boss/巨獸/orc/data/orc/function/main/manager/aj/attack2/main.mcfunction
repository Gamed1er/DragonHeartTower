...
execute as @s at @s as @n[tag=aj.orc.root] run function animated_java:orc/animations/animation.model.attack2/play


execute as @s run tag @s add ToDH.Boss.Action.InAction
schedule function orc:main/manager/aj/attack2/schedule 27t
execute as @s run scoreboard players reset @s ToDH.Boss.1_Orc.Action.Tick
function orc:main/manager/aj/attack2/tick