...
execute if entity @e[tag=ToDH.Boss.1_Orc,tag=boss,tag=ToDH.Boss.Action.InAction] run schedule function orc:main/manager/aj/skill/skill1/tick 1t
...
# execute as @e[tag=ToDH.Boss.1_Orc,tag=boss] as @s if score @s ToDH.Boss.1_Orc.Action.Tick matches 15..17 run function orc:main/manager/aj/attack3/step2
# execute as @e[tag=ToDH.Boss.1_Orc,tag=boss] as @s if score @s ToDH.Boss.1_Orc.Action.Tick matches 22..25 run function orc:main/manager/aj/attack3/step2
# execute as @e[tag=ToDH.Boss.1_Orc,tag=boss] as @s if score @s ToDH.Boss.1_Orc.Action.Tick matches 27..37 run function orc:main/manager/aj/attack3/step
# execute as @e[tag=ToDH.Boss.1_Orc,tag=boss] as @s if score @s ToDH.Boss.1_Orc.Action.Tick matches 40..44 run function orc:main/manager/aj/attack3/step2
# 35