...
## 本體召喚
    summon warden ~ ~ ~ {Health:250f,Tags:["enemy","boss","regulator_mount"],Passengers:[{id:"minecraft:skeleton",Invulnerable:1b,Tags:["enemy","boss","regulator"],HandItems:[{id:"minecraft:bow",Count:1b},{}],HandDropChances:[0.000F,0.085F]}],CustomName:'[{"text":"叱嘯監管者 -","color":"gray","bold":true},{"text":"麥迪根","color":"#6F00FF"}]',Attributes:[{Name:generic.max_health,Base:250}]}
