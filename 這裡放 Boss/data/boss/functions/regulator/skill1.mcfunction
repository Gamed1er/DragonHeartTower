...
item replace entity @e[tag = soul_setting, limit = 3] armor.feet from entity @s armor.feet
item replace entity @e[tag = soul_setting, limit = 3] armor.chest from entity @s armor.chest
item replace entity @e[tag = soul_setting, limit = 3] armor.head from entity @s armor.head
item replace entity @e[tag = soul_setting, limit = 3] armor.legs from entity @s armor.legs
