...
execute as @s unless score ToDH.enemy.Count ToDH.Boss2.Skill.Duration matches 4.. if predicate todh_b2:percent/30 run return run function todh_b2:skill/skill4/start
execute as @s if predicate todh_b2:percent/10 run return run function todh_b2:skill/skill4/start
