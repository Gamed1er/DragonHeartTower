...
$execute at @s rotated ~ 0 positioned ^ ^ ^-0.25 run summon axolotl ~ ~.25 ~ {Invulnerable:1b,NoGravity:0b,Silent:1b,Tags:["ToDH.dodge.M"],active_effects:[{id:invisibility,duration:-1,show_particles:0b}],attributes:[{id:scale,base:0.79f}],Motion:[$(X),0.0625,$(Z)]}
