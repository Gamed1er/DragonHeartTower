...
# execute as @s run ride @s dismount
...
execute if data entity @s active_effects[{id:"minecraft:resistance",amplifier:4b,show_particles:0b}] run effect clear @s resistance
attribute @s knockback_resistance modifier remove dodge:buff