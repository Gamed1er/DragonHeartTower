...
$execute at @s run summon item ~ ~.25 ~ {Invulnerable:1b,NoGravity:0b,Silent:1b,Tags:["ToDH.dodge.M"],Item:{id:"minecraft:stone_button",Count:1b},PickupDelay:-1,Motion:[$(X),$(Y),$(Z)]}
