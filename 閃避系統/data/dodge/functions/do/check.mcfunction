...
execute as @s[tag=!dodge,tag=!Stiff.ing,nbt={OnGround:1b}] if score @s sneakTick matches ..3 if score @s dodgeCD >= @s dodgeCD.limit run function dodge:do/dodge with storage todh:dodge temp.Pos
