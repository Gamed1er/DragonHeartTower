...
title @s title [""]
execute at @s as @s unless score @s OMC.Player.Mana.Points matches 160.. run function omc:player/skill/list/text/not_enough
...
execute at @s as @s if score @s OMC.Player.Mana.Points matches 160.. run function omc:player/skill/id/321/damage with storage omc:function Battle
