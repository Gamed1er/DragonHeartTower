...
execute if entity @e[type=eye_of_ender,nbt={Item:{tag:{Tags:["OMC.item.material","Water"]}}}] run scoreboard players add @s OMC.Skill.ID 3
...
execute at @s run kill @e[type=eye_of_ender,sort=nearest,nbt={Item:{tag:{Tags:["OMC.item.material"]}}}]