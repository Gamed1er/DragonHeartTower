clear @s #omc:material[custom_data={OMC:{item_type:"material"}}]
...
execute as @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{OMC:{item_type:"material"}}}}},sort=nearest] as @s run kill @s