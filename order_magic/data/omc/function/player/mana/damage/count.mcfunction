...
scoreboard players operation @s OMC.Player.Mana.Damage += OMC.Score.reg OMC.Player.Mana.Damage
execute store result score OMC.Score.reg OMC.Player.Mana.Damage run data get entity @s SelectedItem.components.minecraft:custom_data.OMC.ManaStrength 10
scoreboard players operation @s OMC.Player.Mana.Damage += OMC.Score.reg OMC.Player.Mana.Damage
