...
title @s subtitle {"translate":"text.todh.omc.skill.steam_explosion.name","color":"white"}
title @s title [""]
...
execute at @s as @s if score @s OMC.Player.Mana.Points >= @s OMC.Player.Mana.Points.Cost run function omc:player/skill/content/3/steam_explosion/damage with storage omc:function Battle
