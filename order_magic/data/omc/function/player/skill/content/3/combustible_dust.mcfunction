...
title @s subtitle {"translate":"text.todh.omc.skill.combustible_dust.name","color":"gold"}
title @s title [""]
...
execute at @s as @s if score @s OMC.Player.Mana.Points >= @s OMC.Player.Mana.Points.Cost run function omc:player/skill/content/3/combustible_dust/detect