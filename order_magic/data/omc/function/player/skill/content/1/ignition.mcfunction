...
title @s subtitle {"translate":"text.todh.omc.skill.ignition.name","color":"gold"}
title @s title [""]
...
execute as @s at @s run particle minecraft:flame ~ ~ ~ 2.5 0 2.5 0.1 32
tag @s remove OMC.attacker.detect

execute as @s anchored eyes positioned ^ ^ ^1.5 rotated as @s run function omc:player/skill/display/fire_magic_circle_1
execute as @s anchored eyes positioned ^ ^ ^1.5 rotated as @s run function omc:player/skill/display/fire_magic_circle_1
execute as @s anchored eyes positioned ^ ^ ^1.5 rotated as @s run function omc:player/skill/display/fire_magic_circle_1
