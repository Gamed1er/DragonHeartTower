...
title @s subtitle {"translate":"text.todh.omc.skill.bud.name","color":"green"}
title @s title [""]
...
execute at @s as @s if score @s OMC.Player.Mana.Points >= @s OMC.Player.Mana.Points.Cost run effect give @s regeneration 24 0 true
