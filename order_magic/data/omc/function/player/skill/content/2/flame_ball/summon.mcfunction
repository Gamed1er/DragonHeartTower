...
$execute as @s anchored eyes run summon small_fireball ^ ^-.2 ^1 {Tags:["OMC.Skill.Projectile","OMC.Skill.ID.flame_ball"],NoGravity:0b,Motion:[$(X)d,$(Y)d,$(Z)d],Glowing:1b,ExplosionPower:$(DMG)b}
