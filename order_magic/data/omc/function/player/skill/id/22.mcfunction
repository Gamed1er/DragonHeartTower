...
title @s subtitle {"translate":"text.todh.omc.skill.22.name","color":"gold"}
title @s title [""]
...
execute at @s as @s if score @s OMC.Player.Mana.Points >= @s OMC.Player.Mana.Points.Cost run function omc:player/skill/id/22/summon with storage omc:function Skill.vector