...
|賢者之石<sub>_鍊金_</sub>	|`null`	|`null`	|
|禁忌魔法錄<sub>_魔導_</sub>	|`null`	|`null`	|
|腎上腺素<sub>_醫師_</sub>	|`null`	|`null`	|
...
|配方	|名稱	|描述	|數值	|
|---|---|---|---|
|`null`	|攻擊	|釋放後短時間內任何攻擊附帶額外魔法傷害		|DMG`MS*0.5`	<br/>MP`3.0`	|
|無	|附魔	|釋放後短時間內任何攻擊附帶額外魔法傷害		|DMG`MS*0.5`	<br/>MP`3.0`	|
