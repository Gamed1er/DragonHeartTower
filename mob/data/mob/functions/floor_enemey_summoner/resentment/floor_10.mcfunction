...
execute if score now_wave enemy_wave_control matches 1 as @e[tag=mob_summon_point,tag=floor_10,tag=tower_1,sort=random,limit=1] at @s run function boss:regulator/spawn