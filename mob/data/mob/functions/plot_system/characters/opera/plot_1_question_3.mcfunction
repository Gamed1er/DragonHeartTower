execute as @s run scoreboard players set @s plot_progress 12
...
tag @a add meet_madeya
tag @a remove meet_spacy
tag @a remove meet_tokesor_1
tag @a add meet_madeya_1
tag @a remove meet_spacy_1
