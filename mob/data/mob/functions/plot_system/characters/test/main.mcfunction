...
execute if score @s plot_progress matches 3 run scoreboard players set @s plot_type 1
execute if score @s plot_progress matches 3 run data modify storage todh:plot questions set value 2
...
execute if score @s plot_progress matches 5 run scoreboard players set @s plot_type 4

execute if score @s plot_type matches 0 run data modify storage todh:plot plot_delay set value 20

execute if score @s plot_type matches 1 run data modify storage todh:plot plot_delay set value 20
...
execute if score @s plot_type matches 2 run data modify storage todh:plot plot_delay set value 20
