execute if score remain_mob_amount floor_controller matches 0 run scoreboard players remove now_floor floor_controller 1
execute if score now_floor floor_controller matches 0 run scoreboard players remove tower control_panel 1
execute if score now_floor floor_controller matches 0 run scoreboard players set now_floor floor_controller 10
...
advancement revoke @s only mob:stepping_on_black_terracotta